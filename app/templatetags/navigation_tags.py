...
@register.inclusion_tag('tags/_top_menu.html', takes_context=True)
...
@register.inclusion_tag('tags/_navigation_list.html', takes_context=True)
def navigation_list(context, parent, calling_page=None):
    menuitems = parent.get_children().live().in_menu()
    for menuitem in menuitems:
        menuitem.show_dropdown = has_menu_children(menuitem)
        # We don't directly check if calling_page is None since the template
...
@register.inclusion_tag('tags/_top_menu_children.html', takes_context=True)
...
@register.inclusion_tag('tags/_breadcrumbs.html', takes_context=True)
